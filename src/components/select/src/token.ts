...
export const selectGroupKey =
    'ByteSelectGroup' as unknown as InjectionKey<SelectGroupContext>

// as: 断言
// as unknown as    =>    将格式强制转为最后边的形式
export const selectKey = 'ByteSelect' as unknown as InjectionKey<SelectContext>
